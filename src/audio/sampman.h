...
{
	"AUDIO\\MUSIC\\WILD.WAV",
	"AUDIO\\MUSIC\\FLASH.WAV",
	"AUDIO\\MUSIC\\KCHAT.WAV", // 16 khz
	"AUDIO\\MUSIC\\FEVER.WAV",
	"AUDIO\\MUSIC\\VROCK.WAV",
	"AUDIO\\MUSIC\\VCPR.WAV", // 16 khz
	"AUDIO\\MUSIC\\ESPANT.WAV",
	"AUDIO\\MUSIC\\EMOTION.WAV",
	"AUDIO\\MUSIC\\WAVE.WAV",
	"AUDIO\\MUSIC\\MISCOM.WAV",
	"AUDIO\\MUSIC\\CITY.WAV",
	"AUDIO\\MUSIC\\WATER.WAV",
	"AUDIO\\MUSIC\\BEACHAMB.WAV",
	"AUDIO\\MUSIC\\HCITY.WAV",
	"AUDIO\\MUSIC\\HWATER.WAV",
	"AUDIO\\MUSIC\\HBEACH.WAV",
	"AUDIO\\MUSIC\\MALLAMB.WAV",
	"AUDIO\\MUSIC\\STRIP.WAV",
	"AUDIO\\MUSIC\\MALIBU.WAV",
	"AUDIO\\MUSIC\\HOTEL.WAV",
	"AUDIO\\MUSIC\\DIRTRING.WAV",
	"AUDIO\\MUSIC\\LAW4RIOT.WAV",
	"AUDIO\\MUSIC\\AMBSIL.WAV",
	"AUDIO\\MUSIC\\POLICE.WAV", // 16 khz
	"AUDIO\\MUSIC\\TAXI.WAV",
	"AUDIO\\MUSIC\\BCLOSED.WAV",
	"AUDIO\\MUSIC\\BOPEN.WAV",
	"AUDIO\\CUTSCENE\\ASS\\ASS_1.WAV",
	"AUDIO\\CUTSCENE\\ASS\\ASS_2.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_1.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_2A.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_2B.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_3A.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_3B.WAV",
	"AUDIO\\CUTSCENE\\BANK\\BANK_4.WAV",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_1.WAV",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_2.WAV",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_3.WAV",
	"AUDIO\\CUTSCENE\\BUD\\BUD_1.WAV",
	"AUDIO\\CUTSCENE\\BUD\\BUD_2.WAV",
	"AUDIO\\CUTSCENE\\BUD\\BUD_3.WAV",
	"AUDIO\\CUTSCENE\\CAP\\CAP_1.WAV",
	"AUDIO\\CUTSCENE\\CAR\\CAR_1.WAV",
	"AUDIO\\CUTSCENE\\CNT\\CNT_1A.WAV",
	"AUDIO\\CUTSCENE\\CNT\\CNT_1B.WAV",
	"AUDIO\\CUTSCENE\\CNT\\CNT_2.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_1.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_2A.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_2B.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_3.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_4A.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_4A2.WAV",
	"AUDIO\\CUTSCENE\\COK\\COK_4B.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_1.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_2.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_3A.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_4A.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_5A.WAV",
	"AUDIO\\CUTSCENE\\COL\\COL_5B.WAV",
	"AUDIO\\CUTSCENE\\CUB\\CUB_1.WAV",
	"AUDIO\\CUTSCENE\\CUB\\CUB_2.WAV",
	"AUDIO\\CUTSCENE\\CUB\\CUB_3.WAV",
	"AUDIO\\CUTSCENE\\CUB\\CUB_4.WAV",
	"AUDIO\\CUTSCENE\\DRUG\\DRUG_1.WAV",
	"AUDIO\\CUTSCENE\\FIN\\FIN.WAV",
	"AUDIO\\CUTSCENE\\FIN\\FIN2.WAV",
	"AUDIO\\CUTSCENE\\FINALE\\FINALE.WAV",
	"AUDIO\\CUTSCENE\\HAT\\HAT_1.WAV",
	"AUDIO\\CUTSCENE\\HAT\\HAT_2.WAV",
	"AUDIO\\CUTSCENE\\HAT\\HAT_3.WAV",
	"AUDIO\\CUTSCENE\\ICE\\ICE_1.WAV",
	"AUDIO\\CUTSCENE\\INT\\INT_A.WAV",
	"AUDIO\\CUTSCENE\\INT\\INT_B.WAV",
	"AUDIO\\CUTSCENE\\INT\\INT_D.WAV",
	"AUDIO\\CUTSCENE\\INT\\INT_M.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_1A.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_1B.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2A.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2B.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2C.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_3.WAV",
	"AUDIO\\CUTSCENE\\LAW\\LAW_4.WAV",
	"AUDIO\\CUTSCENE\\PHIL\\PHIL_1.WAV",
	"AUDIO\\CUTSCENE\\PHIL\\PHIL_2.WAV",
	"AUDIO\\CUTSCENE\\PORN\\PORN_1.WAV",
	"AUDIO\\CUTSCENE\\PORN\\PORN_2.WAV",
	"AUDIO\\CUTSCENE\\PORN\\PORN_3.WAV",
	"AUDIO\\CUTSCENE\\PORN\\PORN_4.WAV",
	"AUDIO\\CUTSCENE\\RESC\\RESC_1A.WAV",
	"AUDIO\\CUTSCENE\\ROK\\ROK_1.WAV",
	"AUDIO\\CUTSCENE\\ROK\\ROK_2.WAV",
	"AUDIO\\CUTSCENE\\ROK\\ROK_3A.WAV",
	"AUDIO\\CUTSCENE\\STRIPA\\STRIPA.WAV",
	"AUDIO\\CUTSCENE\\TAX\\TAX_1.WAV",
	"AUDIO\\CUTSCENE\\TEX\\TEX_1.WAV",
	"AUDIO\\CUTSCENE\\TEX\\TEX_2.WAV",
	"AUDIO\\CUTSCENE\\TEX\\TEX_3.WAV",
	"AUDIO\\MUSIC\\GLIGHT.WAV",
	"AUDIO\\MUSIC\\FIST.WAV",
	"AUDIO\\MUSIC\\MISCOM.WAV",
	"AUDIO\\MUSIC\\MISCOM.WAV",
	"AUDIO\\MUSIC\\MISCOM.WAV",
	"AUDIO\\MUSIC\\MISCOM.WAV",
